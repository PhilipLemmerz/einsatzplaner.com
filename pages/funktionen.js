                ...
                <section className={styles.functionDetailSection}>
                    ...
                    <div className={styles.functionDetailLeft} id="appointmentFinder">
                        ...
                        <p> Sie verplanen mehr als 2 Teams jeden Tag im Außeneinsatz - dann ist es völlig normal, dass Sie den Überblick verlieren, welches
                            ...
                            im Auto verbringen statt Umsatz bei Aufträgen zu generieren. Dieses Problem potenziert sich je mehr Mitarbeiter Sie verplanen und ist eine häufig
                            vernachlässigte Kostenposition. Genau hier setzt der intelligente Terminfinder unserer Terminplaner Software an.
                        </p>
                        <h4>Lösung:</h4>
                        <p>
                            ...
                            Sie geben nur die Kundenadresse ein und die benötigte Arbeitszeit und Sie erhalten zahlreiche Terminvorschläge - absteigend sortiert nach der geringsten
                            Fahrzeit.
                        </p>
                    </div>
                    <div className={styles.functionDetailRight} id="mapsIntegration">
                        ...
                        <h4>Lösung:</h4>
                        <p>
                            Bei der Arbeit mit der Terminplaner Software einsatzplaner.com haben Sie in der Terminplanung Google-Maps integriert und können sich die Gegebenheiten
                            vor Ort anschauen. So haben Sie die Möglichkeit bereits bei Terminvereinbarung mit dem Kunden eine Lösung für die schwierige Parksituation zu finden.
                            Zudem wissen Ihre Monteure immer genau welches Objekt Sie anfahren müssen, da Sie die Situation vor Ort mit dem Google-Maps Auschnitt vergleichen können.
                        </p>
                    </div>
                    <div className={styles.functionDetailLeft} id="usability">
                        ...
                        <h4>Lösung:</h4>
                        <p>
                            Bei der Entwicklung der Terminplaner Software einsatzplaner.com stand das Bedienkonzept immer an erster Stelle. In iterativen Testschleifen wurde jedes Feature von Menschen unterschiedlichen Alter
                            gestestet und optimiert. Das Ergbins ist eine Terminplaner Software mit verschiedensten Termindarstellungen. Egal ob Wasserfallansicht,
                    ...
                    <div className={styles.functionDetailRight} id="adressCheck">
                        ...
                        <p> Falsche Adressen sind für jede Planung sehr ärgerlich. Insbesondere in Großstädten, wo Straßennamen gleich mehrfach vorkommen kann ein Postleitzahlendreher
                            ...
                            Dies wiederum führt zu einem Zeitverlust durch die Suche der richtigen Adresse.
                        </p>
                        <h4>Lösung:</h4>
                        <p>
                    ...
                    <div className={styles.functionDetailLeft} id="documentation">
                        ...
                        <p> Ihre Mitarbeiter müssen Arbeiten von anderen Monteuren beenden oder fortführen. Monate nach Auftragsdurchführung werden Arbeiten reklamiert oder Folgeaufträge müssen
                            durchgeführt werden. Oder Sie müssen Kundendokumente und Bilder verfügbar haben. Wenn Sie keinen zentralen Ort für diese Informationen und Dokumente haben führt dies zu
